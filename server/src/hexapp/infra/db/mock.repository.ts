...
import type { BaseEntity } from '~/hexapp/domain/base.entity.js'
import { AlreadyExistsError, NotFoundError } from '~/hexapp/domain/base.errors.js'
import { BaseRepository, type RepositoryResult } from '~/hexapp/domain/base.repository.js'
import { type Paginated, type PaginationOptions, Paginator } from '~/hexapp/domain/pagination.js'
...
export abstract class MockRepository<T extends BaseEntity> extends BaseRepository<T> {
	...
	async deleteById(Id: T['id']): Promise<RepositoryResult<T, MockNotFoundError>> {
