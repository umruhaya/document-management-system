...
export class UserService {
	...
	async getByUsername(username: string): Promise<Result<UserEntity, EntityError>> {
	...
	async create(user: {
		username: string
		password: string
	}): Promise<Result<UserEntity & { token: string }, EntityError>> {
	...
	async login(user: { username: string; password: string }): Promise<Result<{ token: string }, EntityError>> {
